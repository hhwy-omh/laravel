...
//				});
				...
				SKUTableDom += '<input type="hidden" name="propvalnameA[]" value=\''+propvalnameArr.join(";")+'\' ><tr propvalids=\''+propvalids+'\' propids=\''+propIdArr.toString()+'\' propvalnames=\''+propvalnameArr.join(";")+'\'  propnames=\''+propNameArr.join(";")+'\' class="sku_table_tr">'+currRowDoms+'<td><input type="text" name="setting_sku_price[]" class="setting_sku_price" value="'+alreadySetSkuPrice+'"/></td><td><input type="text" name="setting_sku_stock[]" class="setting_sku_stock" value="'+alreadySetSkuStock+'"/></td></tr>';
			}
			SKUTableDom += "</table>";
		}
